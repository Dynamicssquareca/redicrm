    ...
    <>
      <nav id="navbar" className="navbar">
        <ul>
          ...
          <li><a className="getstarted-outline" href="tel:+17072447950"><div className='call-btn'><svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
            fill="none"
          ...
          </svg><div className='call-r'>Give us a call <span>+1 70724 47950</span></div></div></a></li>
          <li><ModelBoxGetstatrd /></li>
          {/* <a className="getstarted scrollto" href="/">Get Started</a> */}
        </ul>
