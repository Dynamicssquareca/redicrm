...
const Index = () => {
  return (
    ...
    <>
      <Head>
        <title>Salesforce Customer Service | CRM Frontier</title>
        <link rel="canonical" href="https://www.crmforceplus.com/services/" />
        <meta
          name="description"
          content="Salesforce Service Cloud is a CRM platform that helps businesses provide service and support, including implementation, support, training, optimization, and customization."
        />
        <meta property="og:locale" content="US" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Salesforce Customer Service | CRM Frontier" />
        <meta property="og:description" content="Salesforce Service Cloud is a CRM platform that helps businesses provide service and support, including implementation, support, training, optimization, and customization." />
        <meta property="og:url" content="https://www.crmforceplus.com/services/" />
        ...
        <meta name="twitter:title" content="Salesforce Customer Service | CRM Frontier" />
        <meta name="twitter:description" content="Salesforce Service Cloud is a CRM platform that helps businesses provide service and support, including implementation, support, training, optimization, and customization." />
